...
const services = [
  ...
  },
  {
    ...
    features: ["Shopify Development", "Custom E-commerce", "Payment Integration", "Inventory Management", "Analytics"],
...
export default function Services() {
  return (
    <Layout>
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden pt-32" data-testid="section-services-hero">
