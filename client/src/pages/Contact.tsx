...
export default function Contact() {
  ...
  return (
    <Layout>
      <section className="relative min-h-[50vh] flex items-center justify-center overflow-hidden pt-32" data-testid="section-contact-hero">
                ...
                <div className="space-y-6">
                  {contactInfo.map((info, index) => (
                    <motion.a
                      ...
                      whileHover={{ x: 5 }}
                      className="flex items-start gap-4 p-4 rounded-lg bg-dark-card border border-gold/10 hover:border-gold/30 transition-all group"
