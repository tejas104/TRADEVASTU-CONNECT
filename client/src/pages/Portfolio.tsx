...
const categories = ["All", "Web Development", "UI/UX Design", "Branding", "Mobile Apps", "E-Commerce"];
...
export default function Portfolio() {
  ...
  return (
    <Layout>
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden pt-32" data-testid="section-portfolio-hero">
