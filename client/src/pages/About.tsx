...
export default function About() {
  return (
    <Layout>
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden pt-32" data-testid="section-about-hero">
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10 text-center">
          ...
          >
            We are a premium digital agency under TRADEVASTU ENTERPRISES LLP, 
