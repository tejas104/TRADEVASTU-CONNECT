...
const portfolioData: Record<string, {
  ...
  "1": {
    ...
    fullDescription: "We partnered with a premium fashion brand to create a world-class e-commerce experience. The platform features advanced product filtering, personalized recommendations, and a seamless checkout process designed to maximize conversions.",
  ...
  "4": {
    ...
    fullDescription: "We developed a cutting-edge fitness application that uses artificial intelligence to provide personalized workout recommendations. The app tracks progress, adapts to user preferences, and motivates users to achieve their health goals.",
    client: "FitLife Tech",
    date: "June 2024",
      ...
      <Layout>
        <div className="min-h-screen flex items-center justify-center pt-32">
          <div className="text-center">
            ...
            <GlowButton href="/portfolio" variant="primary" data-testid="button-back-portfolio">
              Back to Portfolio
            </GlowButton>
          </div>
        </div>
  ...
  return (
    <Layout>
      <section className="relative min-h-[80vh] flex items-end overflow-hidden" data-testid="section-project-hero">
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10 pb-16 pt-32">
          <Link href="/portfolio">
            <a className="inline-flex items-center gap-2 text-muted-foreground hover:text-gold mb-8 transition-colors" data-testid="link-back-portfolio">
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <GlassCard className="max-w-4xl mx-auto text-center p-12">
            ...
            <SectionReveal delay={0.3}>
              <GlowButton href="/contact" variant="primary" size="lg" data-testid="button-project-cta">
                Get in Touch
