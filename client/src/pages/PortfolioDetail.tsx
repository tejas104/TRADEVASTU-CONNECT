...
const portfolioData: Record<string, {
  ...
  "4": {
    ...
    description: "Strategic digital campaigns crafted to build brand authority and drive meaningful engagement",
    fullDescription: "We help brands grow their digital presence through data-backed content strategies, social media marketing, and audience engagement. Our approach focuses on building trust, increasing visibility, and creating consistent brand experiences that translate into long-term customer relationships.",
    //client: "FitLife Tech",
    date: "June 2024",
